...
<ul><li><a href=https://github.com/QwenLM/Qwen2.5-Coder>QwenLM/Qwen2.5-Coder</a><p>Qwen2.5-Coder is the code version of Qwen2.5, the large language model series developed by Qwen team, Alibaba Cloud.</p></li><li><a href=https://github.com/canton7/Stylet>canton7/Stylet</a><p>A very lightweight but powerful ViewModel-First MVVM framework for WPF for .NET Framework and .NET Core, inspired by Caliburn.Micro.</p></li><li><a href=https://github.com/MCSLTeam/MCServerLauncher-Future>MCSLTeam/MCServerLauncher-Future</a><p>Future version of MCSL, a brand new server management tool. Redefined, Versatile, Easy to use. (WPF Launcher & Daemon)</p></li><li><a href=https://github.com/FantasticFiasco/mvvm-dialogs>FantasticFiasco/mvvm-dialogs</a><p>Library simplifying the concept of opening dialogs from a view model when using MVVM in WPF</p></li><li><a href=https://github.com/PBH-BTN/PeerBanHelper>PBH-BTN/PeerBanHelper</a><p>自动封禁不受欢迎、吸血和异常的 BT 客户端，并支持自定义规则。PeerId黑名单/UserAgent黑名单/IP CIDR/假进度/超量下载/进度回退/多播追猎/连锁封禁/伪装检测 支持 qBittorrent/Transmission/Deluge/BiglyBT/Vuze(Azureus)</p></li></ul>

**🌟 | 赏的星星**

<ul><li><a href=https://github.com/HunterXuan/wx-tfjs-demo>HunterXuan/wx-tfjs-demo</a><p>微信小程序运行 TensorFlow 的 Demo</p></li><li><a href=https://github.com/maotoumao/MusicFreeDesktop>maotoumao/MusicFreeDesktop</a><p>插件化、定制化、无广告的免费音乐播放器</p></li><li><a href=https://github.com/hatoo/oha>hatoo/oha</a><p>Ohayou(おはよう), HTTP load generator, inspired by rakyll/hey with tui animation.</p></li><li><a href=https://github.com/crzidea/doh>crzidea/doh</a><p>Country-Aware DNS over HTTPS for Optimized CDN Routing</p></li><li><a href=https://github.com/bilibili/Index-1.9B>bilibili/Index-1.9B</a><p>A SOTA lightweight multilingual LLM</p></li></ul>

------------

<p align=center><strong> ちきゅう大爆発 どっか～ん </strong></p>
<p align=center>此文件 <i>README</i> <b>间隔 24 小时</b>自动刷新生成！ <b>设计参考为 <a href=https://github.com/chitsanfei/chitsanfei>chitsanfei</a> 的 Github Profile, Thanks.</b><br>刷新于：9/21/24, 8:42 AM<br>下一次刷新：9/22/24, 8:42 AM</p>
